...
function Box:draw()
  ...
  if not self.ground.fixture:isDestroyed() then
    love.graphics.polygon(
      "fill",
      self.ground.fixture:getBody():getWorldPoints(self.ground.fixture:getShape():getPoints())
    )
    love.graphics.polygon(
      "fill",
      self.wall2.fixture:getBody():getWorldPoints(self.wall2.fixture:getShape():getPoints())
    )
    love.graphics.polygon(
      "fill",
      self.wall1.fixture:getBody():getWorldPoints(self.wall1.fixture:getShape():getPoints())
    )
    love.graphics.polygon(
      "fill",
      self.ceiling.fixture:getBody():getWorldPoints(self.ceiling.fixture:getShape():getPoints())
    )
  end
end
